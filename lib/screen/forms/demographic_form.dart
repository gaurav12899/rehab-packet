                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                            ...
                            children: [
                              Radio(
                                  ...
                                  onChanged: (val) {
                                    setState(() {
                                      _userStatus = val;
                                      form['userStatus'] = userStatus[val];
                                    });
                                  }),
                              Text(
                                "Existing\n Patient",
                      ...
                      Text("Have you had or do you have any of the following:",
                          style: TextStyle(fontWeight: FontWeight.bold)),
                      CheckboxListTile(
                      ...
                      CheckboxListTile(
                          ...
                          onChanged: (newValue) {
                            ...
                            if (checkbox3) {
                              anyOtherProblem.add("NEUROLOGICAL PROBLEM");
                            }
                            if (!checkbox3) {
                              anyOtherProblem.remove("NEUROLOGICAL PROBLEM");
                            }
                          }),
                      CheckboxListTile(
                          activeColor: Colors.red,
                          ...
                          onChanged: (newValue) {
                            ...
                            if (!checkbox4) {
                              anyOtherProblem.remove("VASCULAR DISEASE");
                            }
                          }),
                      CheckboxListTile(
                          activeColor: Colors.red,
                      ...
                      CheckboxListTile(
                          ...
                          onChanged: (newValue) {
                            ...
                            if (checkbox6) {
                              anyOtherProblem.add("RHEUMATOID ARTHRITIS");
                            }
                            if (!checkbox6) {
                              anyOtherProblem.remove("RHEUMATOID ARTHRITIS");
                            }
                          }),
                      CheckboxListTile(
                          activeColor: Colors.red,
                          ...
                          onChanged: (newValue) {
                            ...
                            if (checkbox7) {
                              anyOtherProblem.add("HYPERTENSION/ HIGH BP");
                            }
                            if (!checkbox7) {
                              anyOtherProblem.remove("HYPERTENSION/ HIGH BP");
                            }
                          }),
                      CheckboxListTile(
                          activeColor: Colors.red,
                          ...
                          onChanged: (newValue) {
                            ...
                            if (checkbox8) {
                              anyOtherProblem.add("DIABETES (TYPE 1 & TYPE 2)");
                            }
                            if (!checkbox8) {
                              anyOtherProblem
                                  .remove("DIABETES (TYPE 1 & TYPE 2)");
                            }
                          }),
                      CheckboxListTile(
                          activeColor: Colors.red,
                          ...
                          onChanged: (newValue) {
                            ...
                            if (!checkbox9) {
                              anyOtherProblem.remove("OSTEOARTHRITIS");
                            }
                          }),
                      CheckboxListTile(
                          activeColor: Colors.red,
                      ...
                      CheckboxListTile(
                          ...
                          onChanged: (newValue) {
                            ...
                            if (!checkbox11) {
                              anyOtherProblem.remove("STROKE/TIA/CVA");
                            }
                          }),
                      CheckboxListTile(
                          activeColor: Colors.red,
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            maxLines: 3,
                            onSaved: (val) {
                              anyOtherProblem.add(otherProblemText.text);
                            },
                          )),
                        ],
                      ),
                      PickImage(imagePickFn1, 15),
                      PickImage(imagePickFn2, 15),
                      PickImage(imagePickFn3, 15),
                      Row(
                        // crossAxisAlignment: CrossAxisAlignment.start,
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Radio(
                                  activeColor: Colors.green,
                                  value: 0,
                                  groupValue: _currentlyTakingMedicines,
                                  onChanged: (val) {
                                    setState(() {
                                      _currentlyTakingMedicines = val;
                                      form['currentlyTakingMedicines'] =
                                          currentlyTakingMedicines[val];
                                    });
                                  }),
                              Text(
                                "Yes",
