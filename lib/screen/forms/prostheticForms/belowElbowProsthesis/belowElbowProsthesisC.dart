...
class BelowElbowProsthesisC extends StatefulWidget {
  static const routeName = '/belowElbowProsthesisC';

  var bytelist;
  var username;
  BelowElbowProsthesisC({@required this.bytelist, @required this.username});
  @override
  _BelowElbowProsthesisCState createState() => _BelowElbowProsthesisCState();
}

class _BelowElbowProsthesisCState extends State<BelowElbowProsthesisC> {
