...
class CosmeticRestorationFingersC extends StatefulWidget {
  static const routeName = '/cosmeticRestorationFingersB';

  var bytelist;
  var username;
  CosmeticRestorationFingersC(
      {@required this.bytelist, @required this.username});
  @override
  _CosmeticRestorationFingersCState createState() =>
      _CosmeticRestorationFingersCState();
}

class _CosmeticRestorationFingersCState
    extends State<CosmeticRestorationFingersC> {
