...
class CosmeticRestorationFingersA extends StatefulWidget {
  static const routeName = '/cosmeticRestorationFingersA';
  final username;
  CosmeticRestorationFingersA(this.username);

  @override
  _CosmeticRestorationFingersAState createState() =>
      _CosmeticRestorationFingersAState();
}

class _CosmeticRestorationFingersAState
    extends State<CosmeticRestorationFingersA> {
  ...
  void _printPngBytes(String username) async {
    ...
    Navigator.of(context).push(MaterialPageRoute(
        builder: (ctx) => CosmeticRestorationFingersB(
            bytelist: bytList, username: username)));
